  ...
  return (
    <div className="relative overflow-hidden font-sans pb-24 bg-[#07090e] text-white">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="bg-white/5 border border-white/10 hover:bg-white/10 text-slate-300 font-bold px-6 py-3.5 rounded-lg transition-all duration-300 text-sm flex items-center"
            >
      ...
      <section className="relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto mb-28">
        <div className="border border-white/5 bg-white/[0.01] backdrop-blur-md rounded-2xl p-8 shadow-2xl">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
            {stats.map((stat, idx) => (
              ...
              >
                <h3 className={`text-3xl sm:text-4xl font-extrabold mb-1 tracking-tight ${
                ...
                <h4 className="text-[11px] font-mono font-bold tracking-widest text-slate-300 uppercase mb-1 leading-snug">
                  {stat.label}
                </h4>
