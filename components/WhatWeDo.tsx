...
export default function WhatWeDo() {
  return (
    // <section className="w-full py-16 bg-gradient-to-b from-blue-50 via-white to-blue-100 border-t border-gray-100">
              ...
              return (
                <li key={idx} className="relative flex items-center gap-8">
                  <div className="flex flex-col items-center z-10">
                    ...
                    <span className="w-3 h-3 bg-gray-300 dark:bg-blue-900 rounded-full"></span>
                  </div>
